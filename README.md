...
**Prolix plays __shatranj__, not chess**.
...
The default NNUE file is indicated in the Makefile. If you wish to compile with a different net (provided it is in standard Bullet format), please ensure that the constants in `nnue.cpp` match the architecture of the net.
